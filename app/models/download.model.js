...
module.exports = class Download {
    async downloadXlsx() {
        let ExaminersSalary = await this.findExaminersSalary();
        let DepartmentsSalary = await this.findDepartmentsSalary();
        if (ExaminersSalary != null && DepartmentsSalary != null) {
            ...
            ExaminersSalary.recordset.forEach((examiner) => {
                worksheetExaminer.addRow(examiner);
            });
            DepartmentsSalary.recordset.forEach((department) => {
